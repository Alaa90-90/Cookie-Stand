...
// LAB 07 REQIRED FUNCTIONS FROM LINE 340 -- 480 IN THIS JAVASCRIPT FILE 
// SO YOU CAN COMMENT ENTIRE THE CODE EXEPT GLOPAL VARIABLES AND KEEP FROM  LINE 340 -- 480 TO CHECK IT
...
headingFirst.textContent = 'Cookies';

//tr heading td rest 
function headinghours() {
...
// Branches.prototype. = 
Branches.prototype.bodyData = function () {
...
// LAB 09 REQIRED FUNCTIONS FROM LINE 490 --  IN THIS JAVASCRIPT FILE 
// SO YOU CAN COMMENT ENTIRE THE CODE EXEPT GLOPAL VARIABLES AND KEEP FROM  LINE 490 --  TO CHECK IT
...
function useradding(event) {
    ...
    let userlocationm = event.target.userlocation.value;
    console.log(userlocationm);

    let usermaxcustomm = parseInt(event.target.usermaxcustom.value);
    console.log(usermaxcustomm);

    let userminicustomm = parseInt(event.target.userminicustom.value);
    console.log(userminicustomm);

    let useravrcustomm = parseFloat(event.target.useravrcustom.value);

    console.log(useravrcustomm);

    let userRest = new Branches(userlocationm, usermaxcustomm, usermaxcustomm, useravrcustomm);
    console.log(al);
    parent.deleteRow(-1);
